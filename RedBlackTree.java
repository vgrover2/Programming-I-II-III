...
public class RedBlackTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
    ...
    public void week05ActivityTestPart1() {
        ...
        String newTree = "[16, 26, 32, 45, 57, 62, 82]";

        if (!newTree.equals(rbt.toString())) {
            fail("Rotation unsuccesful");
        }
    }
    ...
    public void week05ActivityTestPart3() {
        ...
        rbt.insert(65);
        rbt.insert(51);
        rbt.rotate(rbt.root.rightChild.rightChild, rbt.root.rightChild);
        assertEquals("[51, 65, 21, 55]", rbt.toString());
    }
